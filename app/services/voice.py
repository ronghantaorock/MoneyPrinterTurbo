...
from app.edge_tts import edge_tts
from app.edge_tts import SubMaker, submaker
from app.edge_tts.submaker import mktimestamp
...
def get_all_azure_voices(filter_locals=None) -> list[str]:
    azure_voices_str = ""
    with open( f"{config.root_dir}/voice_azure.txt", 'r', encoding='utf-8') as f:
        azure_voices_str = f.read()
    azure_voices_str = azure_voices_str.strip()
    voices = []
